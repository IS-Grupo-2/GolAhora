...
export default function RecibosTable({ recibos, filtro, onLimpiarFiltro, onVer, onEditar, onBaja, onImprimir }) {
    if (recibos.length === 0) {
        return (
                        ...
                        <tr key={r.idRecibo}>
                            ...
                            <td>
                                <div className="user-cell-info">
                                    ...
                                    <span>{r.cliente.dni}</span>
                                </div>
                            </td>
                            <td>
                                <div className="user-cell-info">
                                    <strong>{r.cobro.concepto}</strong>
                                    <span>{r.pago.metodoPago}</span>
                                </div>
                            </td>
                            <td>{r.fecha}</td>
